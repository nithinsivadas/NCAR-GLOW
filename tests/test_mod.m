...
assert(abs(iono.A5577(i) - 87.71) < 0.1,   ['A5577: expected 87.71, but got: ', num2str(iono.A5577(i))])
assert(abs(iono.totalIonizationRate(i) - 820.) < 0.1, ['ionrate: expected 820. but got: ', num2str(iono.totalIonizationRate(i))])
assert(abs(iono.hall(i) - 1.1100e-4) < 1e-6, ['hall: expected 1.1100e-4 but got: ', num2str(iono.hall(i))])
